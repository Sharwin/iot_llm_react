/**
 * Base on @file Weather_Monitoring.ino From Rack
 * Fixing Errors for variables and changing codec and rate - Ivan B
...
uint8_t nodeDeviceEUI[8] = {0xAC, 0x1F, 0x09, 0xFF, 0xFE, 0x05, 0x75, 0x43};
...
void data_get()
{
  ...
  uint32_t l = (uint32_t)(result.lux * 100);
